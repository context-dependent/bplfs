...
#' @format The data set has 1222490 rows and 60 columns. \describe{
#'   \item{\code{REC_NUM} \code{fields[1]}}{\code{<int>} Order of record in file [1, 103128]}
#'   \item{\code{SURVYEAR} \code{fields[2]}}{\code{<int>} Survey year [2018, 2018]}
#'   \item{\code{SURVMNTH} \code{fields[3]}}{\code{<fct>} Survey month
#'     \describe{
#'       \item{\code{1}}{January}
...
#'     }}
#'   \item{\code{LFSSTAT} \code{fields[4]}}{\code{<fct>} Labour force status
#'     \describe{
...
#'     }}
#'   \item{\code{PROV} \code{fields[5]}}{\code{<fct>} Province
#'     \describe{
...
#'     }}
#'   \item{\code{CMA} \code{fields[6]}}{\code{<fct>} Nine largest CMAs
#'     \describe{
#'       \item{\code{1}}{Qu�bec}
...
#'     }}
#'   \item{\code{AGE_12} \code{fields[7]}}{\code{<fct>} Five-year age group of respondent
#'     \describe{
...
#'     }}
#'   \item{\code{AGE_6} \code{fields[8]}}{\code{<fct>} Age in 2 and 3 year groups, 15 to 29
#'     \describe{
...
#'     }}
#'   \item{\code{SEX} \code{fields[9]}}{\code{<fct>} Sex of respondent
#'     \describe{
#'       \item{\code{1}}{Male}
#'       \item{\code{2}}{Female}
#'     }}
#'   \item{\code{MARSTAT} \code{fields[10]}}{\code{<fct>} Marital status of respondent
#'     \describe{
#'       \item{\code{1}}{Married}
...
#'     }}
#'   \item{\code{EDUC} \code{fields[11]}}{\code{<fct>} Highest educational attainment
#'     \describe{
...
#'     }}
#'   \item{\code{MJH} \code{fields[12]}}{\code{<fct>} Single or multiple jobholder
#'     \describe{
#'       \item{\code{1}}{Single jobholder, including job changers}
#'       \item{\code{2}}{Multiple jobholder}
#'     }}
#'   \item{\code{EVERWORK} \code{fields[13]}}{\code{<fct>} Identifies if a person has worked in the last year
#'     \describe{
#'       \item{\code{1}}{Yes, within last year}
#'       \item{\code{2}}{Yes, more than 1 year ago}
#'       \item{\code{3}}{No, never worked}
#'     }}
#'   \item{\code{FTPTLAST} \code{fields[14]}}{\code{<fct>} Full- or part-time status of last job
#'     \describe{
#'       \item{\code{1}}{Full-time (30 hours or more)}
#'       \item{\code{2}}{Part-time (1 to 29 hours)}
#'     }}
#'   \item{\code{COWMAIN} \code{fields[15]}}{\code{<fct>} Class of worker, main job
#'     \describe{
...
#'     }}
#'   \item{\code{IMMIG} \code{fields[16]}}{\code{<fct>} Immigrant status
#'     \describe{
...
#'     }}
#'   \item{\code{NAICS_21} \code{fields[17]}}{\code{<fct>} Industry of main job
#'     \describe{
...
#'     }}
#'   \item{\code{NOC_10} \code{fields[18]}}{\code{<fct>} Occupation at main job
#'     \describe{
...
#'     }}
#'   \item{\code{NOC_43} \code{fields[19]}}{\code{<fct>} Occupation at main job
#'     \describe{
...
#'     }}
#'   \item{\code{YABSENT} \code{fields[20]}}{\code{<fct>} Reason of absence, full week
#'     \describe{
...
#'     }}
#'   \item{\code{WKSAWAY} \code{fields[21]}}{\code{<int>} Number of weeks absent from work [1, 99]}
#'   \item{\code{PAYAWAY} \code{fields[22]}}{\code{<fct>} Paid for time off, full-week absence only
#'     \describe{
#'       \item{\code{1}}{Yes}
#'       \item{\code{2}}{No}
#'     }}
#'   \item{\code{UHRSMAIN} \code{fields[23]}}{\code{<int>} Usual hours worked per week at main job [1, 990]}
#'   \item{\code{AHRSMAIN} \code{fields[24]}}{\code{<int>} Actual hours worked per week at main job [0, 990]}
#'   \item{\code{FTPTMAIN} \code{fields[25]}}{\code{<fct>} Full- or part-time status at main or only job
#'     \describe{
#'       \item{\code{1}}{Full-time}
#'       \item{\code{2}}{Part-time}
#'     }}
#'   \item{\code{UTOTHRS} \code{fields[26]}}{\code{<int>} Usual hours worked per week at all jobs [1, 990]}
#'   \item{\code{ATOTHRS} \code{fields[27]}}{\code{<int>} Actual hours worked per week at all jobs [0, 990]}
#'   \item{\code{HRSAWAY} \code{fields[28]}}{\code{<int>} Hours away from work, part-week absence only [0, 990]}
#'   \item{\code{YAWAY} \code{fields[29]}}{\code{<fct>} Reason for part-week absence
#'     \describe{
#'       \item{\code{0}}{Other reasons}
#'       \item{\code{1}}{Own illness or disability}
#'       \item{\code{2}}{Personal or family responsibilities}
...
#'     }}
#'   \item{\code{PAIDOT} \code{fields[30]}}{\code{<int>} Paid overtime hours in reference week [0, 990]}
#'   \item{\code{UNPAIDOT} \code{fields[31]}}{\code{<int>} Unpaid overtime hours in reference week [0, 990]}
#'   \item{\code{XTRAHRS} \code{fields[32]}}{\code{<int>} Number of overtime or extra hours worked [0, 990]}
#'   \item{\code{WHYPT} \code{fields[33]}}{\code{<fct>} Reason for part-time work
#'     \describe{
#'       \item{\code{0}}{Other reasons}
#'       \item{\code{1}}{Own illness or disability}
...
#'     }}
#'   \item{\code{TENURE} \code{fields[34]}}{\code{<int>} Job tenure with current employer [1, 240]}
#'   \item{\code{PREVTEN} \code{fields[35]}}{\code{<int>} Job tenure with previous employer [1, 240]}
#'   \item{\code{HRLYEARN} \code{fields[36]}}{\code{<int>} Usual hourly wages [325, 19231]}
#'   \item{\code{UNION} \code{fields[37]}}{\code{<fct>} Union status
#'     \describe{
...
#'     }}
#'   \item{\code{PERMTEMP} \code{fields[38]}}{\code{<fct>} Job permanency
#'     \describe{
...
#'     }}
#'   \item{\code{ESTSIZE} \code{fields[39]}}{\code{<fct>} Establishment size
#'     \describe{
...
#'     }}
#'   \item{\code{FIRMSIZE} \code{fields[40]}}{\code{<fct>} Firm size
#'     \describe{
#'       \item{\code{1}}{Less than 20 employees}
#'       \item{\code{2}}{20 to 99 employees}
#'       \item{\code{3}}{100 to 500 employees}
#'       \item{\code{4}}{More than 500 employees}
#'     }}
#'   \item{\code{DURUNEMP} \code{fields[41]}}{\code{<int>} Duration of unemployment [1, 99]}
#'   \item{\code{FLOWUNEM} \code{fields[42]}}{\code{<fct>} Flows into unemployment
#'     \describe{
...
#'     }}
#'   \item{\code{UNEMFTPT} \code{fields[43]}}{\code{<fct>} Job seekers by type of work sought and temporary layoffs by work status of last job
#'     \describe{
#'       \item{\code{1}}{Full-time}
#'       \item{\code{2}}{Part-time}
#'       \item{\code{3}}{Future starts}
#'     }}
#'   \item{\code{WHYLEFTO} \code{fields[44]}}{\code{<fct>} Reason for leaving job during previous year
#'     \describe{
...
#'     }}
#'   \item{\code{WHYLEFTN} \code{fields[45]}}{\code{<fct>} Reason for leaving job during previous year
#'     \describe{
#'       \item{\code{0}}{Job leavers, other reasons}
#'       \item{\code{1}}{Job leavers, own illness or disability}
...
#'     }}
#'   \item{\code{DURJLESS} \code{fields[46]}}{\code{<int>} Duration of joblessness [1, 240]}
#'   \item{\code{AVAILABL} \code{fields[47]}}{\code{<fct>} Availability during the reference week
#'     \describe{
#'       \item{\code{1}}{Not available}
#'       \item{\code{2}}{Yes, available}
#'     }}
#'   \item{\code{LKPUBAG} \code{fields[48]}}{\code{<int>} Unemployed, used public employment agency [1, 1]}
#'   \item{\code{LKEMPLOY} \code{fields[49]}}{\code{<int>} Unemployed, checked with employers directly [1, 1]}
#'   \item{\code{LKRELS} \code{fields[50]}}{\code{<int>} Unemployed, checked with friends or relatives [1, 1]}
#'   \item{\code{LKATADS} \code{fields[51]}}{\code{<int>} Unemployed, looked at job ads [1, 1]}
#'   \item{\code{LKANSADS} \code{fields[52]}}{\code{<int>} Unemployed, placed or answered ads [1, 1]}
#'   \item{\code{LKOTHERN} \code{fields[53]}}{\code{<int>} Unemployed, other methods [1, 1]}
#'   \item{\code{PRIORACT} \code{fields[54]}}{\code{<fct>} Main activity before started looking for work
#'     \describe{
#'       \item{\code{0}}{Other}
#'       \item{\code{1}}{Working}
...
#'     }}
#'   \item{\code{YNOLOOK} \code{fields[55]}}{\code{<fct>} Reason for not looking for work during the reference week
#'     \describe{
...
#'     }}
#'   \item{\code{TLOLOOK} \code{fields[56]}}{\code{<fct>} Temporary layoff, looked for work during the last four weeks
#'     \describe{
#'       \item{\code{1}}{Yes}
#'       \item{\code{2}}{No}
#'     }}
#'   \item{\code{SCHOOLN} \code{fields[57]}}{\code{<fct>} Current student status
#'     \describe{
#'       \item{\code{1}}{Non-student}
#'       \item{\code{2}}{Full-time student}
#'       \item{\code{3}}{Part-time student}
#'     }}
#'   \item{\code{EFAMTYPE} \code{fields[58]}}{\code{<fct>} Type of economic family
#'     \describe{
...
#'     }}
#'   \item{\code{AGYOWNK} \code{fields[59]}}{\code{<fct>} Age of youngest child
#'     \describe{
...
#'     }}
#'   \item{\code{FINALWT} \code{fields[60]}}{\code{<int>} Standard final weight [1, 2248]}
#' }
NULL
